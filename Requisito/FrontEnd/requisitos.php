                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Requisitos<small>  Crud de requisitos </small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
...
<form action="?action=<?php echo $alm->requisitoID > 0 ? 'actualizar' : 'registrar'; ?>" method="post" class="pure-form pure-form-stacked" style="margin-bottom:30px;">
                ...
                <div class="panel panel-default">
                    ...
                    <?php foreach($model->Listar() as $r): ?>
                        <tr>
                            ...
                            <td>
                                <a href="?action=editar&requisitoID=<?php echo $r->requisitoID; ?>">Editar</a>
                            </td>
                            <td>
                                <a href="?action=eliminar&requisitoID=<?php echo $r->requisitoID; ?>">Eliminar</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody> 
